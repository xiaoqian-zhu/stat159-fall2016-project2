...
```{r results= 'asis', echo = FALSE, include=FALSE,eval=TRUE}
...
```{r, echo=FALSE,fig.align='center', fig.cap= "Ridge Cross Validation Errors Plot"}
knitr::include_graphics("../images/ridge-cross-validation-errors.png")
```
...
```{r, echo=FALSE,fig.align='center', fig.cap= "Lasso Cross Validation Errors Plot"}
knitr::include_graphics("../images/lasso-cross-validation-errors.png")
```
...
```{r, echo=FALSE,fig.align='center', fig.cap= "PCR Cross Validation Errors Plot"}
knitr::include_graphics("../images/cv-pc-mse-plot.png")
```
...
```{r, echo=FALSE,fig.align='center', fig.cap= "PLS Cross Validation Errors Plot"}
knitr::include_graphics("../images/cv-pls-mse-plot.png")
```
