...
```{r results= 'asis', echo = FALSE}
par(mfrow = c(1,1))
plot(five_matrix_coef[,3], xlab = "Coefficients", ylab = "Value", main = "Trend Lines of Coefficients for Five Regression Models", col = "black")
lines(five_matrix_coef[,3], col="black")
