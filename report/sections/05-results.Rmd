...
```{r results= 'asis', echo = FALSE}
par(mfrow = c(1,1))
plot(five_matrix_coef[,1], xlab = "Coefficients", ylab = "Value", main = "Trend Lines of Coefficients for Five Regression Models")
lines(five_matrix_coef[,1])
points(five_matrix_coef[,2],col= "red")
lines(five_matrix_coef[,2],col = "red")
points(five_matrix_coef[,3], col = "green")
lines(five_matrix_coef[,3],col = "green")
points(five_matrix_coef[,4], col = "yellow")
lines(five_matrix_coef[,4],col = "yellow")
points(five_matrix_coef[,5], col = "blue")
lines(five_matrix_coef[,5],col = "blue")
